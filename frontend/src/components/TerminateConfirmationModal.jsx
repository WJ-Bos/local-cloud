...
function TerminateConfirmationModal({ isOpen, onClose, onConfirm, instanceName }) {
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Terminate Instance">
      <div className="space-y-5">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-primary-gray-500">
            This action cannot be undone. This will permanently terminate the instance
          </p>
          <div className="bg-[#0A0A0B] border border-white/[0.08] rounded-lg p-3">
            <p className="text-sm font-mono font-medium text-white">{instanceName}</p>
          </div>
        </div>
        ...
        <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3">
          <p className="text-xs text-red-300">
            <span className="font-semibold">Warning:</span> The container and all data inside it will be permanently destroyed.
          </p>
        </div>
